...
local teams = {
    {name = "allies", model = "s_m_y_swat_01", weapon = "WEAPON_CARBINERIFLE"} --[[ -- you can change the gun to what ever you what, 'friendly' ]],
...
RegisterCommand("rdwar", function(source, args)
